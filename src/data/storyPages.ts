...
export const FOUNDER_STORY = {
  ...
  sadhvi: {
    title: "Sadhvi Sail",
    question: "A proud Namita's Femme Fitness moment",
    memberNote: "Member of Namita's Femme Fitness, Karwar",
    body:
      "Namita's Femme Fitness is happy to celebrate Sadhvi Sail, crowned Femina Miss India World 2026. As a proud member of this space, her journey reflects what we deeply believe in: women growing stronger, more confident, and graceful in their own way.",
    image: {
      src: "/images/story/sadhvi-sail.webp",
      alt: "Sadhvi Sail, Femina Miss India World 2026.",
    },
  },
  empowerment: [
